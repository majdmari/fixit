...
//                     itemBuilder: (context, index) {
//                       final tradePersonData = favoriteList[index].data();
//                       final tradePersonEmail =
//                           tradePersonData['Email'] as String?;
//                       if (tradePersonEmail == null) {
//                         return Text("Invalid data in Firestore.");
//                       }
//                       return StreamBuilder<
//                           DocumentSnapshot<Map<String, dynamic>>>(
//                         stream: FirebaseFirestore.instance
//                             .collection('tradepersons')
//                             .doc(tradePersonEmail)
//                             .snapshots(),
//                         builder: (context, snapshot) {
...
//                             return Text("Tradeperson data not found.");
//                           } else {
//                             final tradepersonData = snapshot.data!.data()!;
//                             return Padding(
//                               padding:
...
//                                   averageRating:
//                                       tradepersonData['AverageRating'] ?? 0.0,
//                                   onRemove: () {
//                                     // Remove the favorite from Firestore
//                                     String docId = favoriteList[index].id;
//                                     FirebaseFirestore.instance
...
class _FavoriteListScreenState extends State<FavoriteListScreen> {
  Stream<QuerySnapshot<Map<String, dynamic>>>? favoriteListStream;
  User? user;
                ...
                if (snapshot.connectionState == ConnectionState.waiting) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (tradePersonEmail == null) {
                        return SizedBox
                            .shrink(); // Empty container for invalid data
                      }
                      return StreamBuilder<
                          DocumentSnapshot<Map<String, dynamic>>>(
                        stream: FirebaseFirestore.instance
                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState ==
                            ...
                            return Text(
                              ...
                              snapshot.data!.data() == null) {
                            return SizedBox
                                .shrink(); // Empty container when no data found
                          } else {
                            final tradepersonData = snapshot.data!.data()!;
                            return Padding(
                              padding:
